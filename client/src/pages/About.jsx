      ...
      <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4 ">
        ...
        <div className='flex flex-col justify-between gap-8 px-10'>
          <div className='flex gap-5 items-center justify-evenly sm:flex-row px-5 py-5 flex-col bg-gray-300 bg-opacity-60 shadow-lg backdrop-blur-sm rounded-xl bg-white/30'>
            <p className=' sm:w-[30%] w-full font-normal text-base leading-6 text-gray-600 text-justify'>The Ninety-Nines is a unique organization. It is the largest organization worldwide, which is comprised wholly of licenced women pilots. It was founded in the year 1929 when a group of women pilots met at Curtiss Field Long Island, New York, USA. As the original members numbered 99, the club was appropriately given the name, The Ninety-Nines. The world famous aviatrix, Amelia Earhart, was the first president of the club.</p>
